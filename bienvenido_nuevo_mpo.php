...
<html>
  <head>
    ...
    />
    <meta http-equiv="refresh" content="7;URL=http://localhost/index.html" />
  ...
  <body class="body-container">
    <header class="header">
      ...
      <img class="mobile-logo" alt="logo scania" src="imagen/scania_symbol.png" />
    </header>
    ...
    <footer>Scania Argentina © 2021</footer>
